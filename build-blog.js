...
<html lang="en">
<head>
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-3P0MMHTMHR"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'G-3P0MMHTMHR');
    </script>
...
<body>
    <header>
        <nav>
            ...
            <a href="tel:+919548838588" class="call-btn">
    ...
    return `
                <div class="result-card" style="text-align: left; border: 2px solid transparent; transition: all 0.4s ease;">
                    ...
                    <div style="padding: 0 4px;">
                        <span style="display: inline-block; padding: 6px 16px; background: rgba(255,106,0,0.15); color: #ff6a00; border-radius: 16px; font-size: 12px; font-weight: 700; text-transform: uppercase; margin-bottom: 12px; border: 1px solid rgba(255,106,0,0.3);">${category || 'BLOG'}</span>
                        ...
                        <a href="blog/${slug}.html" style="color: #0056d2; font-weight: 600; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; transition: gap 0.3s ease;">Read More <span style="transition: transform 0.3s ease;">→</span></a>
                    </div>
                </div>`;
}
